...
3. Under **Origin**, select the **S3 bucket** (not the static website endpoint).
   ![cf-1](./images/cloudfront/cf-1.png)
4. Under **Origin access**, select **Origin access control settings (recommended)**.
   ...
   ![cf-2](./images/cloudfront/cf-2.png)
   ![cf-3](./images/cloudfront/cf-3.png)
...
6. Click **Create Distribution** and wait for it to deploy.
   ![cf-4](./images/cloudfront/cf-4.png)
...
2. And just paste it:  
   ...
   ```
   ![s3-cf-policy-1](./images/s3/s3-cf-policy-1.png)
3. Click **Save Changes**.
   ![s3-cf-policy-2](./images/s3/s3-cf-policy-2.png)
